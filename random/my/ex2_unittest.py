...
solutions_dir = os.path.join("my/unittest", "solutions")
outputs_dir = os.path.join("my/unittest", "outputs")

# Remove previous outputs folder
shutil.rmtree(outputs_dir, ignore_errors=True)

inputs = sorted(glob(os.path.join("my/unittest", "unittest_input_*"), recursive=True))
if not len(inputs):
